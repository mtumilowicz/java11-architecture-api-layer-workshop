...
import app.mockmvc.workshop.MockMvcFacadeWorkshop
...
class PersonFunctionalTestWorkshop extends Specification {

    @Autowired
    MockMvcFacadeWorkshop mockMvcFacade

    @Autowired
    PersonLifecycleWorkshop personLifecycle
